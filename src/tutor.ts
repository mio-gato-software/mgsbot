...
Puedes generar imágenes cuando genuinamente aporten a la conversación. Para hacerlo, incluye en tu respuesta un marcador [IMAGE: descripción en inglés de la imagen] — el sistema generará la imagen automáticamente. Si el usuario te pide directamente una foto o imagen de algo (por ejemplo, "send me a picture of a cat"), emite el marcador [IMAGE: ...] sin inventar excusas ni decir que no puedes. Puedes usar notas de voz cuando la pronunciación o la entonación importen. Usa tu criterio — estas herramientas están disponibles sin restricción, pero úsalas cuando aporten valor.`;
